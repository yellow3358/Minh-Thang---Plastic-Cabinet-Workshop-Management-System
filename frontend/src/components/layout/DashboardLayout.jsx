...
export default function DashboardLayout() {
    ...
    const getPageTitle = (path) => {
        ...
        if (path.includes("settings/users")) return "Quản lý người dùng";
        ...
        <div className="h-screen bg-slate-50 flex overflow-hidden">
            ...
            <main className="flex-1 transition-all duration-300 flex flex-col min-w-0 overflow-y-auto">
                <header className="sticky top-0 z-40 bg-white flex flex-col w-full border-b border-slate-200 shadow-sm">
                        ...
                        <div className="w-full flex items-center justify-between px-6">
                            <div className="flex items-center gap-2 text-[11px] font-medium text-slate-500 uppercase tracking-wider shrink-0">
                                ...
                                {location.pathname.includes("sales") ? (
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Link
                                            to="/dashboards/warehouse"
                                            className={`transition-colors hover:text-blue-600 ${location.pathname === "/dashboards/warehouse" ? "text-slate-900 font-black" : ""}`}
                                        >
                                            KHO BÃI
                                        </Link>
                                        <ChevronRight className="h-3 w-3 text-slate-300" />
                                        <Link
                                            to="/dashboards/inventory/products"
                                            className={`transition-colors hover:text-blue-600 ${location.pathname === "/dashboards/inventory/products" ? "text-slate-900 font-black" : ""}`}
                                        >
                                            SẢN PHẨM
                                        </Link>
                                    </div>
                                    ...
                                    <span className="text-slate-900 font-black uppercase text-[11px] tracking-wider">{pageTitle}</span>
                                )}
                            </div>
                    ...
                    {/* Tầng 2: Actions & Search - Đồng bộ cho Sales, Products và Users */}
                    {(location.pathname === "/dashboards/sales" ||
                        location.pathname === "/dashboards/inventory/products" ||
                        location.pathname === "/dashboards/settings/users") && (
                                    ...
                                    <div className="flex items-center gap-2 shrink-0">
                                        {location.pathname === "/dashboards/sales" ? (
                                            ...
                                            <div className="flex items-center gap-2">
                                                <Button
                                                    size="sm"
                                                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold rounded px-4 h-8 transition-all active:scale-95"
                                                    onClick={() => window.dispatchEvent(new CustomEvent('open-product-create'))}
                                                >
                                                    New
                                                </Button>
                                                <div className="flex items-center gap-1 ml-4 text-slate-600 font-medium text-sm cursor-pointer hover:text-blue-600 transition-colors">
                                                    Products <Settings className="h-3.5 w-3.5" />
                                                </div>
                                            </div>
                                        ) : location.pathname === "/dashboards/settings/users" ? (
                                            <div className="flex items-center gap-2">
                                                <Button
                                                    size="sm"
                                                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold rounded px-4 h-8 transition-all active:scale-95"
                                                    onClick={() => window.dispatchEvent(new CustomEvent('open-user-create'))}
                                                >
                                                    New
                                                </Button>
                                                <div className="flex items-center gap-1 ml-4 text-slate-600 font-medium text-sm cursor-pointer hover:text-blue-600 transition-colors">
                                                    Users <Settings className="h-3.5 w-3.5" />
                                                </div>
                                            </div>
                                        ) : null}
                                    </div>
